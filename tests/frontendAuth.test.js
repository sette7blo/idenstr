...
test('frontend has no credential prompt or stored dashboard auth state', async () => {
  // The dashboard is intentionally open on the trusted server/mesh. App-to-app
  // callers still send bearer tokens themselves; app.js should not implement a
  // username/password prompt or store dashboard credentials.
